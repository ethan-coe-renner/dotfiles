...
(use-package calendar
  ...
  :hook
  (calendar-mode . (lambda () (setq-local show-trailing-whitespace nil))))
...
(use-package elfeed
  :straight t
  :hook
  (elfeed-show-mode . (lambda () (setq-local show-trailing-whitespace nil)))
  :general-config
...
(use-package eshell
  ...
  ;; Disable show trailing whitespace in eshell
